 ...
 * 9 - 用户
 */
ALTER TABLE `USER` ADD USER_GROUP INTEGER NOT NULL DEFAULT 9
...
/* 添加第一个用户 */
INSERT INTO USER (USERNAME,NICKNAME,PASSWORD_HASH,IMAGE_URL,USER_GROUP)
VALUES('zzz','Z19杂货铺',/*'z19z19'*/'c95cb2148a3c418cb4b06d3a4d0ce378','20191210172512.jpg',1);
